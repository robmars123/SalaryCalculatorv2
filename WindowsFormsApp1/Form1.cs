...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            //annualy input
            decimal originalInput = Convert.ToDecimal(yearlyTxtBx.Text);
            decimal tax = 0;
            ...
            //monthly
            monthlyTxtBx.Text = (yearly / 12).ToString("0.00");
            //biweekly
            biWeeklyTxtBx.Text = (yearly / 26).ToString("0.00");
            //hourly
            hourlyTxtbx.Text = (originalInput / (52 * 40)).ToString("0.00");
        }
